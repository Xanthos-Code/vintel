...
class AvatarFindThread(QThread):
    ...
    def addChatEntry(self, chatEntry, clearCache=False):
        try:
            ...
            Logger().error("An error in the AvatarFindThread: ", str(e))
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                Logger().error("An error in the AvatarFindThread : {0}".format(str(e)))
...
class KOSCheckerThread(QThread):
    ...
    def addRequest(self, names, requestType, onlyKos=False):
        try:
            ...
            Logger().error("An error in the KOSCheckerThread: {0}".format(str(e)))
    ...
    def run(self):
        while True:
            ...
            Logger().error("KOSCheckerThread emitting kos_result for: state = {0}, text = {1}, requestType = {2}, hasKos = {3}".format(
    ...
    def run(self):
        while True:
            ...
            try:
                ...
                Logger().error("An error in the MapStatisticsThread: {0}".format(str(e)))
